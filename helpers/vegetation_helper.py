...
class VegetationHelper(BaseDetectionHelper):
    ...
    def _detect_textured_objects(self, bbox_image, bbox):
        ...
        if texture.max() > texture.min():
            ...
            print("  ⚠️ TEXTURE: Constant texture detected - using zero array")
    ...
    def _normalize_image_values(self, image):
        ...
        if img_max <= 1.0 and img_min >= 0.0:
            ...
            if img_max > img_min:
                ...
                print("  ⚠️ NORM: Constant values detected - using zero array")
    ...
    def _prepare_vegetation_bands(self, bbox_image):
        ...
        if bands >= 5:
            ...
            if valid_pixels > 0:
                ...
                print("  ⚠️ BANDS: No valid pixels for NDVI, falling back to green band")
            ...
            if bands == 3:
                ...
                green = bbox_image[:, :, 1]
                print("  🌿 Using green channel for vegetation detection")
                return green
            else:
                ...
                print("  🌿 Using green+NIR combination")
                return combined
        else:
